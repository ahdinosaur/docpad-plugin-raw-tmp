  ...
  module.exports = function(BasePlugin) {
    ...
    return raw = (function(_super) {
      ...
      raw.prototype.writeAfter = function(opts, next) {
        var config, docpad, docpadConfig, eachr, mkdirp, ncp, outPath, pathUtil, safeps, srcPath;
        eachr = require('eachr');
        ncp = require('ncp');
        ...
        return eachr(config, function(target, key) {
          var CYGWIN, WINDOWS, XCOPY, command, options, out, src;
          docpad.log("info", "Copying " + key);
          target.src || (target.src = 'raw');
